...
/**
 * Represents an image that supports changing individual pixel colors. Only the
 * following formats are supported: png, jpg, gif.
 * 
...
public class Pixmap
{
    ...
    private BufferedImage copyImage (Dimension from,
                                     Dimension to,
                                     BufferedImage original)
    {
        int[] data = new int[from.width * from.height];
        BufferedImage result =
            new BufferedImage(to.width, to.height, BufferedImage.TYPE_INT_RGB);
